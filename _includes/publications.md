<h2 id="publications" style="margin: 2px 0px -15px;">Selected Works</h2>
...
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    {% if link.image %}
    <img src="{{ link.image }}" class="teaser img-fluid z-depth-1" width="540" height="246" loading="lazy" alt="Teaser figure: {{ link.title | strip_html | escape }}">
    {% endif %}
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
      ...
      {% if link.notes %}
      <abbr class="badge award">{{ link.notes }}</abbr>
      {% endif %}
      </div>
    <div class="links">
      {% if link.pdf %}
